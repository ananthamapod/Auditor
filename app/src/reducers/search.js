import { SEARCH, RECEIVE_RESULTS } from '../actions/actionTypes'
...
function search(state = {isFetching: false, results: default_state}, action) {
  switch (action.type) {
    case SEARCH:
      return {isFetching: true}
    case RECEIVE_RESULTS:
      return {isFetching: false, results: action.results}
    default:
      return state
  }
}
